              ...
              <div className="row">
                <div className="column">
                  <div className="dropdown">
                    ...
                    <p onClick={e => onButtonClick(e, 0)} className="dropbtn">
                      Dairy
                    </p>
                ...
                <div className="column">
                  <div className="dropdown">
                    ...
                    <p onClick={e => onButtonClick(e, 1)} className="dropbtn">
                      Tree Nuts
                    </p>
                ...
                <div className="column">
                  <div className="dropdown">
                    ...
                    <p onClick={e => onButtonClick(e, 2)} className="dropbtn">
                      Wheat
                    </p>
                ...
                <div className="column">
                  <div className="dropdown">
                    ...
                    <p onClick={e => onButtonClick(e, 3)} className="dropbtn">
                      Egg
                    </p>
                ...
                <div className="column">
                  <div className="dropdown">
                    ...
                    <p onClick={e => onButtonClick(e, 4)} className="dropbtn">
                      Sesame
                    </p>
                ...
                <div className="column">
                  <div className="dropdown">
                    ...
                    <p onClick={e => onButtonClick(e, 5)} className="dropbtn">
                      Soy
                    </p>
